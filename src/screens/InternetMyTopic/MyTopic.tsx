...
type Props = NativeStackScreenProps<RootStackParamList, "MyTopic">;
...
const MyTopic: React.FC<Props> = ({ navigation }) => {
  ...
  const fetchTopics = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        console.log("Fetched topics:", response.data.allTopics);
        const topicsData = response.data.allTopics || [];
    ...
    return (
      <GradientBackground>
        <View style={[styles.container, styles.centerContainer]}>
          ...
          <CustomText style={styles.loadingText}>Loading topics...</CustomText>
        </View>
      </GradientBackground>
    );
  }
            ...
            <>
              ...
              <View style={styles.commentsSection}>
                ...
                {commentsLoading ? (
                  ...
                  <CustomText style={styles.noComments}>No comments yet. Be the first!</CustomText>
                ) : (
                  <FlatList
